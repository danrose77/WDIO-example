...
class OMS extends Page {
  ...
  get Password()          {return $('//input[@id="loginPassword"]');}
  get LoginBtn()          {return $('//*[@id="dijit_form_Form_0"]/div[6]/span[1]');}
  get UserMenu()          {return $('li:nth-child(2) > a > span.idxHeaderDropDownArrow');}
  get LogoutBTN()          {return $('#dijit_MenuItem_3_text');}
  get OrderNumber()          {return $('//*[@id="idx_form_TextBox_0"]');}
  get FindOrderBTN()          {return $('//*[@id="dijit_form_Button_1_label"]');}
  get OrderSearchBTN()          {return $('/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[2]/div[1]/div[4]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[3]/span[1]/span[1]/span[1]/span[3]');}
  get FirstResultLnk()          {return $('/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[2]/div[1]/div[4]/div[1]/div[1]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/div[3]/div[2]/div[1]/table[1]/tbody[1]/tr[1]/td[1]/div[1]/a[1]');}
  get OrderStatus()          {return $("#sc_plat_dojo_layout_AdvancedTableLayout_70 > table > tbody > tr:nth-child(1) > td.advancedTableLayout-valueCell.tableLayout-cols-2-valueCell.tableLayout-cols-2-valueCell-1");}
  get ReloadOrder()          {return $("//a[@class='idxLinkDerived idxLink idxLinkHover dijitHover']");}
  get CloseOrder()          {return $("//div[@class='dijitTabInner dijitTabContent idxButtonDerived dijitClosable dijitTab dijitTabChecked dijitChecked']//span[@title='Close']");}
  get ContentPane()          {return $("//div[@id='idx_layout_ContentPane_466']");}
  get TableItem()          {return $("//td[4]//div[1]//div[1]//span[1]");}
  get ShippedStatus()          {return $("//td[@class='gridxCell']//span[contains(text(),'Shipped')]");}
  get ReturnRefundedStatus()          {return $("//td[@class='gridxCell']//span[contains(text(),'Return Refunded')]");}
  get QuantityValue()          {return $$("//td[@aria-label='Quantity']");}
  get cancelOrderLink()          {return $("//a[contains(text(),'Cancel Products')]");}
  get cancelNext()          {return $$("//span[contains(text(),'Next')]");}
  get cancelOk()          {return $$("//span[contains(text(),'Ok')]");}
  get cancelConfirm()          {return $$("//span[contains(text(),'Confirm')]");}
  get applyHold()          {return $("//a[contains(text(),'Apply Holds')]");}
  get saveHold()          {return $$("//span[contains(text(),'Save')]");}
  get shoppingBagSKU()          {return $("//dd[@class='code']");}
  get warningExpand()          {return $('//img[@id="infoBlockIDImage"]');}
  get overrideLink()          {return $('//a[@id="overridelink"]');}
  get ACUsername()          {return $('//input[@name="UserId"]');}
  get ACPassword()          {return $('//input[@name="Password"]');}
  get ACSubmit()          {return $('//input[@name="btnLogin"]');}
  get ACInventoryLink()          {return $("//td[contains(text(),'Inventory')]");}
  get ACAdjustInventoryLink()          {return $("//td[contains(text(),'Adjust Inventory')]");}
  get ACItemID()          {return $('//input[@name="xml:/Item/@ItemID"]');}
  get ACProceed()          {return $('//input[@value="Proceed"]');}
  get IBMse_userDD()          {return $("//a[@title='CSQAtest | UK DC']//span[@class='idxHeaderDropDownArrow']");}
  get IBMse_logout()          {return $("#dijit_MenuItem_1_text");}
  get IBMse_CSuserDD()          {return $("//span[@class='glyphicon glyphicon-chevron-down']");}
  get IBMse_CSlogout()          {return $("//span[@isc-i18n='globals.ACTION_Logout']");}
  get OMS_SQL_username()          {return $("//input[@name='YFSEnvironment.userId']");}
  get OMS_SQL_password()          {return $("//input[@name='YFSEnvironment.password']");}
  get OMS_SQL_entry()          {return $("//textarea[@id='SQLStatement']");}
  get OMS_SQL_run()          {return $("//span[contains(text(),'Run query')]");}
  get OMS_SQL_shipAdviceNo()          {return $("#QueryResult > tbody > tr:nth-child(2) > td");}
  get OMS_SQL_results()          {return $$("td.nowrapsearchlabel");}
  get API_InvokeFlow()          {return $("//input[@value='InvokeFlow']");}
  get API_ServiceName()          {return $("//input[@name='ServiceName']");}
  get API_ApiName()          {return $("//select[@id='ApiName']");}
  get API_userId()          {return $("//table[@cellpadding='7']//input[@name='YFSEnvironment.userId']");}
  ...
  get APRD_RunStatus()          {return $("//span[contains(@class,'execstate execstatedisplay overall h4')]");}
  get OMS_ProductList()          {return $$("div.gridxMain > div.gridxBody.gridxBodyRowHoverEffect > div > table > tbody > tr > td:nth-child(4) > div > div > span");}
  get holdLock()  {return $$("img[alt='On hold']");}
  get resolveHolds()  {return $("//a[contains(text(),'Resolve Holds')]");}
  get selectHold()  {return $$("table > tbody > tr > td > span");}
  get saveHoldButton()  {return $("//span[contains(text(),'Save')]");}
  get returnToSummary()  {return $$("//span[contains(text(),'Go to Order Summary')]");}
  get ReturnsTab()  {return $("//span[contains(text(),'Returns')]");}
  get ExchangeOrderNumber()  {return $("td[class='advancedTableLayout-valueCell twoColumnTableLayout-valueCell twoColumnTableLayout-valueCell-2'] > div > div:nth-child(3) > div:nth-child(2) > div > div > a");}
  get ExchangeItemList()  {return $$("//td[4]//div[1]//div[1]//span[1]");}
  ...
  retrieveOrder(inputOrder) {
    ...
    if (inputOrder !== undefined) {
      ...
      this.FindOrderBTN.click();
      this.CloseOrder.waitForDisplayed();
      if (OMSquantitiesRecorded === false) {
  ...
  sterlingQueryForShipDetails() {
    ...
    while (counterTick !== resultsCount) {
      ...
      skuslist.filter(x => {return x.No === ITEM_ID })[resultPosition].SHIPNODE_KEY = SHIPNODE_KEY;
      skuslist.filter(x => {return x.No === ITEM_ID })[resultPosition].PRIME_LINE_NO = PRIME_LINE_NO;
      skuslist.filter(x => {return x.No === ITEM_ID })[resultPosition].SHIP_ADVICE_NO = SHIP_ADVICE_NO;
  ...
  getReturnsDetails() {
    ...
    browser.pause(1500);
    exchangeOrderNumber = this.ExchangeOrderNumber.getHTML(false);
    Screenshot.viewport();
    this.CloseOrder.click();
    Screenshot.viewport();
    browser.pause(500);
    this.retrieveOrder(exchangeOrderNumber);
    Screenshot.viewport();
    referenceNumber = exchangeOrderNumber;
    browser.pause(2000);
    skuslist = [];
