...
class Adyen extends Page {
    get Test() {
        return $('//*[@id="subcontent"]/div[1]/div/form/div[2]/div[1]/div[1]/a[2]');
    }

    get Account() {
        return $('//*[@id="subcontent"]/div[1]/div/form/div[2]/div[1]/div[2]/div/div[2]//input');
    }
    ...
    get Password() {
        return $("//input[@id='j_password']");
    }

    get Submit() {
        return $("//input[contains(@value,'Log in')]");
    }

    get AccountMenu() {
        return $("//div[contains(text(),'Account')]");
    }

    get SkinsMenu() {
        return $("//span[contains(text(),'Skins')]");
    }

    get skin_au() {
        return $("//a[contains(text(),'superdry.au skin')]");
    }

    get skin_befr() {
        return $("//a[contains(text(),'superdry.befr skin')]");
    }

    get skin_benl() {
        return $("//a[contains(text(),'superdry.benl skin')]");
    }

    get skin_caen() {
        return $("//a[contains(text(),'superdry.caen skin')]");
    }

    get skin_cafr() {
        return $("//a[contains(text(),'superdry.cafr skin')]");
    }

    get skin_chde() {
        return $("//a[contains(text(),'superdry.chde skin')]");
    }

    get skin_chfr() {
        return $("//a[contains(text(),'superdry.chfr skin')]");
    }

    get skin_cn() {
        return $("//a[contains(text(),'superdry.cn skin')]");
    }

    get skin_com() {
        return $("//a[contains(text(),'superdry.com skin')]");
    }

    get skin_de() {
        return $("//a[contains(text(),'superdry.de skin')]");
    }

    get skin_dk() {
        return $("//a[contains(text(),'superdry.dk skin')]");
    }

    get skin_es() {
        return $("//a[contains(text(),'superdry.es skin')]");
    }

    get skin_fi() {
        return $("//a[contains(text(),'superdry.fi skin')]");
    }

    get skin_fr() {
        return $("//a[contains(text(),'superdry.fr skin')]");
    }

    get skin_gr() {
        return $("//a[contains(text(),'superdry.gr skin')]");
    }

    get skin_hken() {
        return $("//a[contains(text(),'superdry.hken skin')]");
    }

    get skin_hkzh() {
        return $("//a[contains(text(),'superdry.hkzh skin')]");
    }

    get skin_ie() {
        return $("//a[contains(text(),'superdry.ie skin')]");
    }

    get skin_it() {
        return $("//a[contains(text(),'superdry.it skin')]");
    }

    get skin_kr() {
        return $("//a[contains(text(),'superdry.kr skin')]");
    }

    get skin_nl() {
        return $("//a[contains(text(),'superdry.nl skin')]");
    }

    get skin_no() {
        return $("//a[contains(text(),'superdry.no skin')]");
    }

    get skin_pl() {
        return $("//a[contains(text(),'superdry.pl skin')]");
    }

    get skin_se() {
        return $("//a[contains(text(),'superdry.se skin')]");
    }

    get skin_tw() {
        return $("//a[contains(text(),'superdry.tw skin')]");
    }

    get skin_us() {
        return $("//a[contains(text(),'superdry.us skin')]");
    }

    get resultURL() {
        return $("//*[@id='skin-details-and-hmacs']/table[2]/tbody[2]/tr[1]/td[1]/input");
    }

    get continueURL() {
        return $("//*[@id='skin-details-and-hmacs']/table[2]/tbody[2]/tr[2]/td[1]/input");
    }
