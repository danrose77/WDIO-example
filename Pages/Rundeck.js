...
class Rundeck extends Page {
  ...
  get rundeck_password()          {return $("//input[@id='password']");}
  get rundeck_submitBTN()          {return $("//button[@type='submit']");}
  get rundeck_pjctsrch()          {return $("//input[@placeholder='Project search']");}
  get rundeck_export_to_OMS()          {return $("//a[contains(text(),'Export to OMS')]");}
  get rundeck_export_specific_order_to_OMS()          {return $("//a[contains(text(),'Export Specific Order to OMS')]");}
  get rundeck_order()          {return $("//input[@name='extra.option.orders']");}
  get rundeck_site()          {return $("//input[@name='extra.option.site']");}
  get rundeck_execFormRunButton()          {return $("//button[@id='execFormRunButton']");}
  get rundeck_success()          {return $("//span[contains(@class,'execstate execstatedisplay overall h4')]");}

  // Rundeck projects
  get rundeck_pjct_Amber()          {return $("//span[contains(text(),'Amber')]");}
  get rundeck_pjct_BlackAP1()          {return $("//span[contains(text(),'Black_ap-southeast-1')]");}
  get rundeck_pjct_BlackAP2()          {return $("//span[contains(text(),'Black_ap-southeast-2')]");}
  get rundeck_pjct_BlackEC1()          {return $("//span[contains(text(),'Black_eu-central-1')]");}
  get rundeck_pjct_BlackEW1()          {return $("//span[contains(text(),'Black_eu-west-1')]");}
  get rundeck_pjct_BlackUS2()          {return $("//span[contains(text(),'Black_us-west-2')]");}
  get rundeck_pjct_Blue()          {return $("//span[contains(text(),'Blue')]");}
  get rundeck_pjct_Brown()          {return $("//span[contains(text(),'Brown')]");}
  get rundeck_pjct_Burgundy()          {return $("//span[contains(text(),'Burgundy')]");}
  get rundeck_pjct_Copper()          {return $("//span[contains(text(),'Copper')]");}
  get rundeck_pjct_Cyan()          {return $("//span[contains(text(),'Cyan')]");}
  get rundeck_pjct_Gray()          {return $("//span[contains(text(),'Gray')]");}
  get rundeck_pjct_Green()          {return $("//span[contains(text(),'Green')]");}
  get rundeck_pjct_Ivory()          {return $("//span[contains(text(),'Ivory')]");}
  get rundeck_pjct_Lilac()          {return $("//span[contains(text(),'Lilac')]");}
  get rundeck_pjct_Magenta()          {return $("//span[contains(text(),'Magenta')]");}
  get rundeck_pjct_Mauve()          {return $("//span[contains(text(),'Mauve')]");}
  get rundeck_pjct_Olive()          {return $("//span[contains(text(),'Olive')]");}
  get rundeck_pjct_Orange()          {return $("//span[contains(text(),'Orange')]");}
  get rundeck_pjct_Peach()          {return $("//span[contains(text(),'Peach')]");}
  get rundeck_pjct_Pink()          {return $("//span[contains(text(),'Pink')]");}
  get rundeck_pjct_Plum()          {return $("//span[contains(text(),'Plum')]");}
  get rundeck_pjct_Purple()          {return $("//span[contains(text(),'Purple')]");}
  get rundeck_pjct_Red()          {return $("//span[contains(text(),'Red')]");}
  get rundeck_pjct_Russet()          {return $("//span[contains(text(),'Russet')]");}
  get rundeck_pjct_Sage()          {return $("//span[contains(text(),'Sage')]");}
  get rundeck_pjct_Slate()          {return $("//span[contains(text(),'Slate')]");}
