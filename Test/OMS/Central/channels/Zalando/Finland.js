...
// Duke
//const SKU1 = '210302600012302A006';
//const SKU2 = '3185648500028FB3007';
//Baron
const SKU1 = '2103026000148GVU002';
const SKU2 = '2102421500481GEQ006';

const Qty1 = 1;
const Qty2 = 2;
const username = 'danrosetest+finland@gmail.com';
...
describe(specname+Testname1, () => {
    ...
    it('Go to OMS and retrieve order', () => {
        ...
        write.jsonOrderFiles('ZALANDOzafi_');
    },);
});
/*
...
describe(specname+Testname4, () => {
    ...
    it('Go to OMS and retrieve order', () => {
        ...
        write.xmlOrderFiles('ZALANDOzade_');
    },);
});
