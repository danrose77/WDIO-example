...
// Duke
//const SKU1 = '102020100008816A003';
// Eagle
const SKU1 = '2102421500481GEQ001';

const SKU2 = '1040405000250ZJ9001';
const Qty1 = 1;
const Qty2 = 2;
const username = 'danrosetest+US@gmail.com';
...
describe(specname+Testname2, () => {
    ...
    it('Go to OMS and retrieve order', () => {
        ...
        write.xmlOrderFiles('AMAZONUS');
        write.xmlOrderFiles('MACYSUS');
    },);
});
/*
